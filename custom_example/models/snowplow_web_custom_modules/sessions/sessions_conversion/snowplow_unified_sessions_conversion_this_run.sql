...
-- `this_run` table so calc in drop and recompute fashion. This will be joined into the `snowplow_unified_sessions_custom` incremental table
{{
  config(
    sort='session_identifier',
