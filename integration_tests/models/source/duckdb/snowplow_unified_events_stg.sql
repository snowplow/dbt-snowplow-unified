  ...
  , flatten as (
    select
      *,
      ...
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'id' AS id,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'name' AS name,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'previousId' AS previousId,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'previousName' AS previousName,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'previousType' AS previousType,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'transitionType' AS transitionType,
      unstruct_event_com_snowplowanalytics_mobile_screen_view_1->0->>'type' AS type,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'firstEventId' AS firstEventId,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'previousSessionId' AS previousSessionId,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'sessionId' AS sessionId,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'sessionIndex' AS sessionIndex,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'userId' AS userId,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'eventIndex' AS eventIndex,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'storageMechanism' AS storageMechanism,
      contexts_com_snowplowanalytics_snowplow_client_session_1->0->>'firstEventTimestamp' AS firstEventTimestamp,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'latitude' AS latitude,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'longitude' AS longitude,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'latitudeLongitudeAccuracy' AS latitudeLongitudeAccuracy,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'altitude' AS altitude,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'altitudeAccuracy' AS altitudeAccuracy,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'bearing' AS bearing,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'speed' AS speed,
      contexts_com_snowplowanalytics_snowplow_geolocation_context_1->0->>'timestamp' AS timestamp,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'viewport' AS viewport,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'documentSize' AS documentSize,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'resolution' AS resolution,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'colorDepth' AS colorDepth,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'devicePixelRatio' AS devicePixelRatio,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'cookiesEnabled' AS cookiesEnabled,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'online' AS online,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'browserLanguage' AS browserLanguage,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'documentLanguage' AS documentLanguage,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'webdriver' AS webdriver,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'deviceMemory' AS deviceMemory,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'hardwareConcurrency' AS hardwareConcurrency,
      contexts_com_snowplowanalytics_snowplow_browser_context_1->0->>'tabId' AS tabId,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'deviceManufacturer' AS deviceManufacturer,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'deviceModel' AS deviceModel,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'osType' AS osType,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'osVersion' AS osVersion,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'androidIdfa' AS androidIdfa,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'appleIdfa' AS appleIdfa,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'appleIdfv' AS appleIdfv,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'carrier' AS carrier,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'openIdfa' AS openIdfa,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'networkTechnology' AS networkTechnology,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'networkType' AS networkType,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'physicalMemory' AS physicalMemory,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'systemAvailableMemory' AS systemAvailableMemory,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'appAvailableMemory' AS appAvailableMemory,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'batteryLevel' AS batteryLevel,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'batteryState' AS batteryState,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'lowPowerMode' AS lowPowerMode,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'availableStorage' AS availableStorage,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'totalStorage' AS totalStorage,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'isPortrait' AS isPortrait,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'resolution' AS resolution2,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'scale' AS scale,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'language' AS language,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'appSetId' AS appSetId,
      contexts_com_snowplowanalytics_snowplow_mobile_context_1->0->>'appSetIdScope' AS appSetIdScope,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'id' AS id2,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'name' AS name2,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'activity' AS activity,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'fragment' AS fragment,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'topViewController' AS topViewController,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'type' AS type2,
      contexts_com_snowplowanalytics_mobile_screen_1->0->>'viewController' AS viewController,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'message' AS message,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'programmingLanguage' AS programmingLanguage,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'className' AS className,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'exceptionName' AS exceptionName,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'isFatal' AS isFatal,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'lineNumber' AS lineNumber,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'stackTrace' AS stackTrace,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'threadId' AS threadId,
      unstruct_event_com_snowplowanalytics_snowplow_application_error_1->0->>'threadName' AS threadName
