...
{% if not var("snowplow__enable_cwv", false) %}
    ...
    with prep as (
        select
            *,
            ...
            from_json(com_snowplowanalytics_snowplow_browser_context_1_0_0,'array<struct<viewport:string,documentSize:string,resolution:string,colorDepth:string,devicePixelRatio:string,cookiesEnabled:string,online:string,browserLanguage:string,documentLanguage:string,webdriver:string,deviceMemory:string,hardwareConcurrency:string,tabId:string>>') as com_snowplowanalytics_snowplow_browser_context_1,
            ...
            from_json(unstruct_event_com_snowplowanalytics_snowplow_application_error_1_0_0,'array<struct<message:string,programmingLanguage:string,className:string,exceptionName:string,isFatal:boolean,lineNumber:float,stackTrace:string, threadId:int, threadName:string>>') as unstruct_event_com_snowplowanalytics_snowplow_application_error_1
        from
    ...
    select
        ...
        array(struct(contexts_com_snowplowanalytics_snowplow_geolocation_context_1[0].latitude::float AS latitude,
            contexts_com_snowplowanalytics_snowplow_geolocation_context_1[0].longitude::float AS longitude,
            contexts_com_snowplowanalytics_snowplow_geolocation_context_1[0].latitudeLongitudeAccuracy::float AS latitude_longitude_accuracy,
            contexts_com_snowplowanalytics_snowplow_geolocation_context_1[0].altitude::float AS altitude,
            contexts_com_snowplowanalytics_snowplow_geolocation_context_1[0].altitudeAccuracy::float AS altitude_accuracy,
        ...
        array(struct(com_snowplowanalytics_snowplow_browser_context_1[0].viewport::string AS viewport,
            com_snowplowanalytics_snowplow_browser_context_1[0].documentSize::string AS document_size,
            com_snowplowanalytics_snowplow_browser_context_1[0].resolution::string AS resolution,
            com_snowplowanalytics_snowplow_browser_context_1[0].colorDepth::int AS color_depth,
            com_snowplowanalytics_snowplow_browser_context_1[0].devicePixelRatio::float AS device_pixel_ratio,
            com_snowplowanalytics_snowplow_browser_context_1[0].cookiesEnabled::boolean AS cookies_enabled,
            com_snowplowanalytics_snowplow_browser_context_1[0].online::boolean AS online,
            com_snowplowanalytics_snowplow_browser_context_1[0].browserLanguage::string AS browser_language,
            com_snowplowanalytics_snowplow_browser_context_1[0].documentLanguage::string AS document_language,
            com_snowplowanalytics_snowplow_browser_context_1[0].webdriver::boolean AS webdriver,
            com_snowplowanalytics_snowplow_browser_context_1[0].deviceMemory::int AS device_memory,
            com_snowplowanalytics_snowplow_browser_context_1[0].hardwareConcurrency::int AS hardware_concurrency,
            com_snowplowanalytics_snowplow_browser_context_1[0].tabId::string AS tab_id)) as com_snowplowanalytics_snowplow_browser_context_1,
        array(struct(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0].deviceManufacturer::string AS device_manufacturer,
            ...
            contexts_com_snowplowanalytics_snowplow_mobile_context_1[0].totalStorage::int AS total_storage,
        ...
        struct(unstruct_event_com_snowplowanalytics_snowplow_application_error_1[0].message::string AS message,
            ...
            unstruct_event_com_snowplowanalytics_snowplow_application_error_1[0].lineNumber::float AS line_number,
