...
for db in ${DATABASES[@]}; do
  ...
  eval "dbt run --select snowplow_unified_integration_tests.source --full-refresh --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 1, snowplow__enable_cwv: false, snowplow__start_date: 2010-01-01}' --target $db " || exit 1;
  ...
  eval "dbt run --full-refresh --select snowplow_unified_integration_tests.source --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 220, snowplow__enable_cwv: false, snowplow__enable_conversions: true}' --target $db " || exit 1;
  eval "dbt run --full-refresh --select +snowplow_unified_conversions --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 220, snowplow__enable_cwv: false, snowplow__enable_conversions: true}' --target $db " || exit 1;


  echo "Snowplow unified integration tests: App errors module"
  eval "dbt run --full-refresh --select snowplow_unified_integration_tests.source --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 220, snowplow__enable_cwv: false, snowplow__enable_app_errors: true}' --target $db " || exit 1;
  eval "dbt run --full-refresh --select +snowplow_unified_app_errors --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 220, snowplow__enable_cwv: false, snowplow__enable_app_errors: true}' --target $db " || exit 1;
  ...
  eval "dbt run --select snowplow_unified_integration_tests.source --full-refresh --vars '{snowplow__allow_refresh: true, snowplow__backfill_limit_days: 243, snowplow__enable_cwv: false}' --target $db " || exit 1;
