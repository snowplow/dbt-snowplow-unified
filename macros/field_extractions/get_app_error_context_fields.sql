...
{% macro get_app_error_context_fields() %}
  {{ return(adapter.dispatch('get_app_error_context_fields', 'snowplow_unified')()) }}
{%- endmacro -%}
...
{% macro bigquery__get_app_error_context_fields() %}
  {% if var('snowplow__enable_browser_context', false) %}
...
{% macro spark__get_app_error_context_fields() %}
  {% if var('snowplow__enable_browser_context', false) %}
...
{% macro snowflake__get_app_error_context_fields() %}
  {% if var('snowplow__enable_browser_context', false) %}
