...
{% macro duckdb__get_app_error_event_fields() %}
  {% if var('snowplow__enable_app_errors', false) %}
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'message' as STRING) AS app_error__message
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'programmingLanguage' as STRING) AS app_error__programming_language
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'className' as STRING) AS app_error__class_name
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'exceptionName' as STRING) AS app_error__exception_name
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'isFatal' as BOOLEAN) AS app_error__is_fatal
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'lineNumber' as INT) AS app_error__line_number
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'stackTrace' as STRING) AS app_error__stack_trace
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'threadId' as INT) AS app_error__thread_id
    , cast(unstruct_event_com_snowplowanalytics_snowplow_application_error_1->>'threadName' as STRING) AS app_error__thread_name
  {% else %}
    , cast(null as {{ dbt.type_string() }}) as app_error__message
    , cast(null as {{ dbt.type_string() }}) as app_error__programming_language
    , cast(null as {{ dbt.type_string() }}) as app_error__class_name
