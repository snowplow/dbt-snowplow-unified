...
{% macro spark__get_mobile_context_fields() %}
  {% if var('snowplow__enable_mobile_context', false) %}
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.device_manufacturer')::BOOLEAN AS mobile__device_manufacturer
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.device_model')::BOOLEAN AS mobile__device_model
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.os_type')::BOOLEAN AS mobile__os_type
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.os_version')::BOOLEAN AS mobile__os_version
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.android_idfa')::BOOLEAN AS mobile__android_idfa
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.apple_idfa')::BOOLEAN AS mobile__apple_idfa
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.apple_idfv')::BOOLEAN AS mobile__apple_idfv
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.carrier')::BOOLEAN AS mobile__carrier
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.open_idfa')::BOOLEAN AS mobile__open_idfa
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.network_technology')::BOOLEAN AS mobile__network_technology
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.network_type')::BOOLEAN AS mobile__network_type
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.physical_memory')::BOOLEAN AS mobile__physical_memory
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.system_available_memory')::BOOLEAN AS mobile__system_available_memory
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.app_available_memory')::BOOLEAN AS mobile__app_available_memory
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.battery_level')::BOOLEAN AS mobile__battery_level
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.battery_state')::BOOLEAN AS mobile__battery_state
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.low_power_mode')::BOOLEAN AS mobile__low_power_mode
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.available_storage')::BOOLEAN AS mobile__available_storage
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.total_storage')::BOOLEAN AS mobile__total_storage
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.is_portrait')::BOOLEAN AS mobile__is_portrait
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.resolution')::BOOLEAN AS mobile__resolution
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.scale')::BOOLEAN AS mobile__scale
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.language')::BOOLEAN AS mobile__language
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.app_set_id')::BOOLEAN AS mobile__app_set_id
    , get_json_object(contexts_com_snowplowanalytics_snowplow_mobile_context_1[0]::String,'$.app_set_id_scope')::BOOLEAN AS mobile__app_set_id_scope
  {% else %}
    , cast(null as {{ dbt.type_string() }}) as mobile__device_manufacturer
    , cast(null as {{ dbt.type_string() }}) as mobile__device_model
    , cast(null as {{ dbt.type_string() }}) as mobile__os_type
