...
{% macro unified_cluster_by_fields_sessions_lifecycle() %}

  {{ return(adapter.dispatch('unified_cluster_by_fields_sessions_lifecycle', 'snowplow_unified')()) }}
...
{% macro unified_cluster_by_fields_views() %}

  {{ return(adapter.dispatch('unified_cluster_by_fields_views', 'snowplow_unified')()) }}

{% endmacro %}

{% macro default__unified_cluster_by_fields_views() %}
...
{% macro unified_cluster_by_fields_sessions() %}

  {{ return(adapter.dispatch('unified_cluster_by_fields_sessions', 'snowplow_unified')()) }}
...
{% macro unified_cluster_by_fields_users() %}

  {{ return(adapter.dispatch('unified_cluster_by_fields_users', 'snowplow_unified')()) }}
...
{% macro unified_cluster_by_fields_consent() %}
  ...
  {{ return(adapter.dispatch('unified_cluster_by_fields_consent', 'snowplow_unified')()) }}
...
{% macro unified_cluster_by_fields_cwv() %}
  ...
  {{ return(adapter.dispatch('unified_cluster_by_fields_cwv', 'snowplow_unified')()) }}
